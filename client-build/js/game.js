        ...
        run: function(started_callback) {
        	...
        	var wait = setInterval(function() {
                if(self.map.isLoaded && self.spritesLoaded()) {
                    ...
                    // self.host = "localhost"; // Définissez l'hôte du serveur WebSocket
                    // self.port = 8000;        // Définissez le port du serveur WebSocket
                    // console.log("Attempting to connect to WebSocket server at:", self.host, self.port);
